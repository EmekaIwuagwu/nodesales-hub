...
library KortanaLibrary {
    ...
    function quote(uint amountA, uint reserveA, uint reserveB) internal pure returns (uint amountB) {
        require(amountA > 0, "KortanaLibrary: INSUFFICIENT_AMOUNT");
        require(reserveA > 0 && reserveB > 0, "KortanaLibrary: INSUFFICIENT_LIQUIDITY");
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) internal pure returns (uint amountIn) {
        require(amountOut > 0, "KortanaLibrary: INSUFFICIENT_OUTPUT_AMOUNT");
        require(reserveIn > 0 && reserveOut > 0, "KortanaLibrary: INSUFFICIENT_LIQUIDITY");
